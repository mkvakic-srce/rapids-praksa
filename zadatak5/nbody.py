...
#         split_list_x = []
#         chunk_size = len(x) // numOfProccesses

#         for i in range(0, len(x, chunk_size)):
#             split_list_x.append(x[i:i + chunk_size])

#         split_list_x = []

#         for i in range(0, len(y, chunk_size)):
#             split_list_y.append(y[i:i + chunk_size])

#     else:
#         split_list_x = None
#         split_

#     # scattering to all proccesses
#     scattered_list = comm.scatter(split_list, root = 0)

#     xout, yout = [], [] # dvije prazne liste
#     for i in scattered_list:
#         if abs(x) > lenscale:
#             x -= 2*x
#         if abs(y) > lenscale:
#             y -= 2*y
...
#     # ovdje napraviti gather prije return
#     return xout, yout
